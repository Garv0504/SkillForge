...
const CallToAction = () => {
  return (
    <div className='bg-gradient-to-b from-white via-blue-100 to-blue-300 w-full'>
      <div className='flex flex-col items-center gap-4 pb-24 pt-10 px-8 md:px-0 '>
      <h1 className='text-xl md:text-4xl text-gray-800 font-semibold'>Learn anything, anytime, anywhere</h1>
      <p className='text-gray-500 sm:text-sm'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus ipsam ducimus et nostrum quae quibusdam</p>
